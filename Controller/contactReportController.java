...
public class contactReportController implements Initializable {
    ...
    /**This function controls the appointment contact search.
     * @param keyEvent, a JavaFX keyEvent provided by a key click
     * @throws SQLException an exception
     */
    @FXML
    private void onKeyReleasedAppointmentSearchContactText(KeyEvent keyEvent) throws SQLException {
        searchContacts(contactSearchTextField.getText());
     ...
     */
    private void searchContacts(String searchInput) {
        try (var connection = connect.startConnection()) {
            ...
            //if int, search against contactID
